...
describe("app", function() {
  ...
  it("app has messages", function() {
    expect(typeof testApp.messages).to.equal('object');
  });
  ...
  it("app deletes correctly (post, post, post, delete(0), delete(2))", function() {
    testApp.post('1')
    testApp.post('2')
    testApp.post('3')
    testApp.delete(0)
  ...
  it("app updates correctly (post, post, post, delete(0), update(2))", function() {
    testApp.post('1')
    testApp.post('2')
    testApp.delete(1)
